...
public enum DbType {
    ...
    MySQL_8("com.mysql.cj.jdbc.Driver", "jdbc:mysql://%s:%s/%s?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=%s&allowPublicKeyRetrieval=true", "mysql-connector-java-8.0.11.jar"),
